...
Main entry point với New Modern UI Design
"""
import sys
import os
...
class AutoTextImageApp:
    def __init__(self):
        self.main_window = MainWindowNew()
...
def main():
    ...
    try:
        ...
        # Khởi động ứng dụng với New Modern UI
        app = AutoTextImageApp()
        app.set_single_instance(single_instance)
        
        print("✨ Auto Text & Image v1.3.8 - New Modern Design")
        print("🎨 Inspired by Frame 2.png - Enhanced UI Experience")
        print("🔍 Search feature + 1440x1080 Window + Single Instance")
        print("🔤 SVN Poppins Font + Modern Blue Theme")
        print("=" * 60)
